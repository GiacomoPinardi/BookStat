...
public class GraphicInterface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("Enable auto zoom (watch easly the differences)");
    ...
    private void runGraphicInterface(double[] book1Stats, double[] book2Stats) {               
        ...
        MyPanel p = new MyPanel(this.width, this.height, book1Stats, book2Stats, jCheckBox2.isSelected(), filename, jCheckBox1.isSelected());
